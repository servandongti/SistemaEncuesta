    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Agregar Nueva pregunta</h4></center>
            </div>
			...
			<form method="POST" action="registro.php">
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="nompr">
					</div>
				</div>
				
				<div class="row form-group" style="display:none;">
					<div class="col-sm-2">
						<label class="control-label" style="position:relative; top:7px;">Stop:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" value="1" name="stop">
					</div>
				</div>
